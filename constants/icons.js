...
export const food = require('../assets/icons/fast-food-64.png');
...
export const florist = require('../assets/icons/florist.png');
export const grocery = require('../assets/icons/grocery.png');
export const starOutline = require('../assets/icons/star-outline.png');
export default {
  back,
  car,
  cutlery,
